...
<CardGrid>
  ...
  <LinkCard title="Skills Reference" href="/devsquad-copilot/skills/" description="All 18 built-in skills with activation model." />
  <LinkCard title="Core Components" href="/devsquad-copilot/core-components/instructions/" description="Built-in instructions, hooks, MCP servers, and context management." />
</CardGrid>
