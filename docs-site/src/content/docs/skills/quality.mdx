...
- [Architecture and Planning Skills](/devsquad-copilot/skills/architecture/) for ADR and decision-recording workflows
- [Choosing the Right Extension](/devsquad-copilot/core-components/comparison/) for when to use skills vs other mechanisms