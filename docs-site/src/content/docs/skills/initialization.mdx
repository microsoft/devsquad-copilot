...
- [Architecture and Planning Skills](/skills/architecture/) for design-phase capabilities
- [Getting Started](/getting-started/) for the full installation and setup guide
