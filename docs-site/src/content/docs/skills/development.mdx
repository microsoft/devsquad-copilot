...
- [Initialization Skills](/devsquad-copilot/skills/initialization/) for project setup
- [Work Item Skills](/devsquad-copilot/skills/work-items/) for board integration workflows