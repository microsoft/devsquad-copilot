...
:::note
**Proposed** ADRs are open for discussion and may change. If you are implementing against a Proposed ADR, treat its decisions as provisional and flag this in your task notes. Only **Accepted** ADRs represent finalized team decisions.
:::
...
- [Framework Architecture](/devsquad-copilot/framework/) for how ADRs fit into the delivery workflow
- [Contributing](/devsquad-copilot/contributing/) for how to propose new ADRs
