...
- [Comprehension Checkpoints](/concepts/comprehension-checkpoints/): What happens during medium and high impact tasks
- [Delivery Guardrails](/delivery-guardrails/): The philosophy behind structured verification
- [ADR 0005: Socratic AI](/decisions/): The decision behind adaptive ceremony

---
## What to Read Next

- [Comprehension Checkpoints](/concepts/comprehension-checkpoints/) for how checkpoints vary by impact level
- [Implementation Guardrails](/guardrails/implementation/) for how classification affects workflow
