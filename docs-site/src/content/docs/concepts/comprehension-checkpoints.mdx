...
- [Impact Classification](/devsquad-copilot/concepts/impact-classification/): When checkpoints trigger based on impact level
- [Delivery Guardrails](/devsquad-copilot/delivery-guardrails/): The philosophy behind structured verification
- [Reasoning and Handoff](/devsquad-copilot/concepts/reasoning-and-handoff/): How decisions are recorded and passed between phases

---
## What to Read Next

- [Impact Classification](/devsquad-copilot/concepts/impact-classification/) for how impact level determines checkpoint depth
