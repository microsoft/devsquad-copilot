...
- Requires **VS Code 1.111.0** or later
...
<CardGrid>
  <LinkCard title="FAQ" href="/devsquad-copilot/faq/" description="Common questions and answers about workflow, guardrails, and extensibility." />
  <LinkCard title="Open an issue" href="https://github.com/microsoft/devsquad-copilot/issues" description="Report a bug with steps to reproduce, expected vs actual behavior, and environment details." />
  <LinkCard title="Getting Started" href="/devsquad-copilot/getting-started/" description="Revisit installation, prerequisites, and initialization steps." />
</CardGrid>
