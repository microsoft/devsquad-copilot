...
<CardGrid>
  <Card title="Impact Classification" icon="warning">
    **Low** (typo): direct action. **Medium** (function change): plan + confirm. **High** (service/API): ADR + explicit approval. See [Impact Classification](/concepts/impact-classification/).
  </Card>
