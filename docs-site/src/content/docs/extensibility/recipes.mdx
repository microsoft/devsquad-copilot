...
Concrete examples for each extension type. For the decision tree and mechanism comparison, see [Extensibility Overview](/extensibility/).
...
<Aside>
  Tool Extensions are in **Preview** ([ADR 0010](/decisions/#adr-0010-agent-tool-extension-)). The mechanism may change.
</Aside>

## Related

- [Extensibility Overview](/extensibility/): Decision tree and mechanism comparison
- [Skills Reference](/skills/): All 18 built-in skills
- [Core Components: Instructions](/core-components/instructions/): Built-in instruction reference
- [Core Components: Hooks](/core-components/hooks/): Built-in hook reference

---

## What to Read Next

- [Extensibility Overview](/extensibility/) for the decision tree
- [Skills](/skills/) for the full skill catalog
