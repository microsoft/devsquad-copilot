...
- [Conductor](/devsquad-copilot/agents/conductor/) for the main entry point
- [Getting Started](/devsquad-copilot/getting-started/) to install and run your first workflow
