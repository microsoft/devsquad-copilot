...
| **Handoff** | → implement, specify, or plan |
...
| **Handoff** | → plan, decompose, or specify |
| **Skills** | documentation-style, reasoning |
...
| **Handoff** | → specify, plan, decompose, or kickoff |
...
- [Lifecycle Agents](/devsquad-copilot/agents/lifecycle/) for the main delivery pipeline
- [Delivery Guardrails](/devsquad-copilot/delivery-guardrails/) for the philosophy behind quality enforcement
