...
- [Lifecycle Agents](/devsquad-copilot/agents/lifecycle/) for phase-specific agents
- [Support Agents](/devsquad-copilot/agents/support/) for cross-cutting capabilities
