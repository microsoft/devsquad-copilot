...
- [Support Agents](/devsquad-copilot/agents/support/) for review, security, and sprint agents
- [Skills](/devsquad-copilot/skills/) for capabilities used by lifecycle agents
