...
All decisions live in versioned files, not in session memory. The framework relies on disk artifacts as the canonical source of design decisions. See [Context Management](/devsquad-copilot/core-components/context-management/) for the full artifact authority model.
...
<CardGrid>
  <Card title="Implementation Guardrails" icon="setting">
    Individual developer guardrails during implementation. See [Implementation Guardrails](/devsquad-copilot/guardrails/implementation/).
  </Card>
  <Card title="Reasoning and Handoff" icon="document">
    How decisions are recorded and passed between phases. See [Reasoning and Handoff](/devsquad-copilot/concepts/reasoning-and-handoff/).
  </Card>
</CardGrid>

## What to Read Next

- [Work Items](/devsquad-copilot/work-items/) for board integration details
- [Reasoning and Handoff](/devsquad-copilot/concepts/reasoning-and-handoff/) for how decisions transfer between agents
- [Implementation Guardrails](/devsquad-copilot/guardrails/implementation/) for enforcement mechanisms
