...
| Transition | Cleanup | Reason |
|-----------|---------|--------|
| specify → plan | Recommended | Spec is a persistent artifact; plan should read from the file |
| plan → decompose | Recommended | Tasks should come from artifacts, not from memory |
| decompose → implement | Recommended | Decomposition context is not relevant for implementation |
| implement → review | **Mandatory** | Independent review requires clean context |
