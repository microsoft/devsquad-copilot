...
<CardGrid>
  <LinkCard title="Getting Started" href="/devsquad-copilot/getting-started/" description="Install and run your first workflow." />
  <LinkCard title="Contributing" href="/devsquad-copilot/contributing/" description="How to contribute agents, skills, instructions, and hooks." />
</CardGrid>
