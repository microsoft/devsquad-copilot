...
Do not use instructions for logic that depends on runtime context, external data, or multi-step reasoning. Use [Skills](../../skills/) for context-dependent behavior, or [Hooks](../../core-components/hooks/) for automated validation with script execution.
:::
...
- [Skills](../../skills/) for context-dependent agent capabilities
- [Extension Recipes](../../extensibility/recipes/) for creating custom instructions
