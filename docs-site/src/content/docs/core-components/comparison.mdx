...
| I want to... | Use |
|---|---|
| Enforce formatting or naming rules on specific files | [Instructions](/core-components/instructions/) |
| Add domain knowledge that agents load when relevant | [Skills](/skills/) |
| Run validation scripts at specific lifecycle points | [Hooks](/core-components/hooks/) |
| Connect agents to external data or APIs | [MCP Servers](/core-components/mcp-servers/) |
| Create a new workflow or specialized behavior | [Custom Agent](/extensibility/) |
...
- [Extensibility Overview](/extensibility/) for the full decision tree
