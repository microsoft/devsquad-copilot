...
<img src={overviewImg.src} alt="DevSquad Framework Architecture Overview" style="border-radius: 12px; margin: 1.5rem 0; box-shadow: 0 4px 24px rgba(0,0,0,0.12);" />
...
|-----------|-------|-------------|
| [Specialist Agents](/devsquad-copilot/agents/overview/) | 13 | Autonomous agents for each delivery phase |
