...
<CardGrid>
  <Card title="13 Agents" icon="rocket">
    One conductor, 12 specialists, and nested worker sub-agents for parallel execution.
  </Card>
  <Card title="18 Skills" icon="puzzle">
    Reusable knowledge packages loaded on demand by context relevance.
  </Card>
  <Card title="7 Instructions" icon="document">
    Path-specific behavioral rules applied automatically by file type.
  </Card>
  <Card title="5 Lifecycle Hooks" icon="setting">
    Deterministic scripts for validation, tagging, and platform detection.
  </Card>
</CardGrid>
...
SDD (Spec-Driven Development) is the execution model across these phases.
