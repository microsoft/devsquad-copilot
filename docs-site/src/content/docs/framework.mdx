...
Dashed arrows: auto-activated (agent does not explicitly request). Solid arrows: agent-initiated. See [Extensibility](/devsquad-copilot/extensibility/) for the full decision tree.
...
:::note
Changes to upstream artifacts (specs, ADRs, priorities) are not automatically propagated to downstream work items. See [Team Coordination](/devsquad-copilot/guardrails/team-coordination/#change-propagation-limitations) for the full limitation matrix and recommended manual steps.
:::

See [Team Coordination](/devsquad-copilot/guardrails/team-coordination/) for multi-developer guardrails.
