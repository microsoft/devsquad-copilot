...
description: All 14 Architecture Decision Records documenting significant technical decisions.
banner:
  content: |
...
## ADR 0013: Harness Learnings <Badge text="Proposed" variant="caution" />
...
## ADR 0014: Agent Intent Governance <Badge text="Accepted" variant="success" />
...
- [Framework Architecture](../framework/) for how ADRs fit into the delivery workflow
- [Contributing](../contributing/) for how to propose new ADRs
